...
BENCHMARK_REGISTER_F(mwmr_queue, push_then_pop_lvalue)->ThreadRange(1, std::thread::hardware_concurrency());
...
BENCHMARK_REGISTER_F(mwmr_queue, push_then_pop_rvalue)->ThreadRange(1, std::thread::hardware_concurrency());
